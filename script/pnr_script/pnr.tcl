...
#   set placer_enable_enhanced_router TRUE; # enabling the actual GR instead of GR estimator. Increased run time! // GR = global router
...
# The  psynopt  command  performs incremental preroute or postroute optimization on the current design. 
# Performs incremental timing-driven  (setup timing, by default) logic optimization with placement legalization.
...
set_prefered_routing dinection -layers (metal1) -direction horizontal 
